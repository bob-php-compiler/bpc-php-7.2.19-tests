...
$arr = array(1234, 12.34, TRUE, FALSE, NULL, $str, 'key'=>$str, $str=>'val');
$tmp = &$arr;
$arr[] = $tmp;
...
$arr1 = array(1234, 12.34, TRUE, FALSE, NULL, 'key'=>$str, $str=>'val');
$tmp = &$arr1;
$arr1[] = $tmp;
$arr2 = array(1234, 12.34, TRUE, FALSE, NULL, $str=>'val');
$tmp = &$arr2;
$arr2[] = $tmp;
