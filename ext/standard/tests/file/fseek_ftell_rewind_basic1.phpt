...
$filename = "./fseek_ftell_rewind_basic1.tmp"; // this is name of the file created by create_files()
...
foreach($file_content_types as $file_content_type){
  ...
  foreach($file_modes as $file_mode) {
    ...
    create_files ( '.', 1, $file_content_type, 0755, 512, "w", "fseek_ftell_rewind_basic"
