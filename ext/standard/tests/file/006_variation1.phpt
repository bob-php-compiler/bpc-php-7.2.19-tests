...
$file_name = "006_variation1.tmp";
$file_handle = fopen($file_name, "w");
fclose($file_handle);
$dir_name = "006-variation1";
mkdir($dir_name);
...
--CLEAN--
<?php
chmod("006_variation1.tmp", 0777);
chmod("006-variation1", 0777);
unlink("006_variation1.tmp");
rmdir("006-variation1");
?>
--EXPECTF--
