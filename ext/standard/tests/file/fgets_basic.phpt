...
foreach($file_modes as $file_mode) {
  ...
  foreach($file_content_types as $file_content_type) {
    ...
    create_files ( '.', 1, $file_content_type, 0755, 50, "w", "fgets_basic", 1, "bytes"); //create a file
    $filename = "fgets_basic1.tmp"; // this is name of the file created by create_files()
