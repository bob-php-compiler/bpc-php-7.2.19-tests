...
Error: 2 - array_intersect_uassoc() expects parameter 3 to be callable, Object without __toString() given, %s(%d)
NULL
Error: 2 - array_intersect_uassoc() expects parameter 4 to be callable, Object without __toString() given, %s(%d)
NULL
===DONE===
