...
Warning: array_map() expects parameter 1 to be callable, non-existent::square given in %s on line %d
NULL
-- with existent class and non-existent method --

Warning: array_map() expects parameter 1 to be callable, SimpleClass::non-existent given in %s on line %d
NULL
Done
