...
--FILE--
<?php
	$finfo = finfo_open(FILEINFO_NONE, "bug71527私はガラスを食べられます.magic");
	$info = finfo_file($finfo, __FILE__);
	var_dump($info);
?>
--EXPECTF--
Warning: finfo_open(): Failed to load magic database at 'bug71527私はガラスを食べられます.magic'. in %sbug71527-mb.php on line %d
